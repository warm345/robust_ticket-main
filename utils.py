...
import mindspore
from mindspore.nn.utils.rnn import pad_sequence
...
class OutputStorage:
    """
    This object stores the intermediate gradients of the output a the given mindspore module, which
...
class Collator:
    ...
    def __call__(self, features):
        ...
        labels = mindspore.tensor([x for x in labels])
