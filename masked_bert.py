...
class MaskedBertForSequenceClassification(BertForSequenceClassification, ABC):
    ...
    def get_sparsity(self, layer, head):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            return mindspore.mean(query_mask), mindspore.mean(key_mask), mindspore.mean(value_mask)
    ...
    def get_sparsity_head(self, layer, head):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            return (mindspore.mean(query_mask) + mindspore.mean(key_mask) + mindspore.mean(value_mask)) / 3
    ...
    def get_sparsity_dense(self, layer):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            return mindspore.mean(mask1), mindspore.mean(mask2), mindspore.mean(mask3)
    ...
    def get_sparsity_mlp(self, layer):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            return (mindspore.mean(mask1) + mindspore.mean(mask2) + mindspore.mean(mask3)) / 3
    ...
    def get_sparsity_layer(self, layer):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            sparsity = mindspore.sum(mask1) + mindspore.sum(mask2) + mindspore.sum(mask3) + mindspore.sum(value_mask) + mindspore.sum(
                query_mask) + mindspore.sum(key_mask)
            sparsity = sparsity / (
    ...
    def get_sparsity_layer_attn(self, layer):  # both are 0-indexed
        ...
        with mindspore.no_grad():
            ...
            sparsity = mindspore.sum(value_mask) + mindspore.sum(query_mask) + mindspore.sum(key_mask)
